...
> **0.5** is the first **named published** 0.x line (GitHub Release when tagged:
...
| **Version** | 0.x — **0.5** is the named published line (workspace version until the tag: [`Cargo.toml`](./Cargo.toml) / [`CHANGELOG.md`](./CHANGELOG.md)) |
