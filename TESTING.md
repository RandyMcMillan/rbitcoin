...
The nightly job (`scripts/core-functional/nightly.sh`) warns — it does
not fail — when a newer Bitcoin Core release exists than the inventory
pin. Default `cargo test` does **not** invoke Core’s Python suite.
