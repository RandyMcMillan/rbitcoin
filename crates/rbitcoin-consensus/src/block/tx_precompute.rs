...
impl TxPrecompute {
    ...
    pub fn from_tx(tx: &Transaction) -> Self {
        ...
        for txin in &tx.input {
            ...
            sigops =
                sigops.saturating_add(super::script_sigop_count(txin.script_sig.as_bytes(), false));
        ...
        for txout in &tx.output {
            ...
            sigops = sigops.saturating_add(super::script_sigop_count(
...
mod tests {
    ...
    fn assert_matches_rust_bitcoin(tx: &Transaction) {
        ...
        assert_eq!(p.sigops, super::super::legacy_sigop_count(tx), "sigops");
