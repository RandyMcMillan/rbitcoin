...
**Status:** **0.6.1** is lab-to-operator: **early production / high-scrutiny**,
...
| Not Core/Fulcrum | No production SLA; 0.6.1 is high-scrutiny 0.x; schema unstable until 1.0; reindex on incompatible layout changes |
