...
| **SH tip materialize** | Sliced k-way: n-cpu workers, 256 KiB pages, no extra catalog files; ingest OA **~128 MiB** (2²²×32 B) | **≪1 GiB** extra heap | No 0.5–1 GiB OA image per shard |
