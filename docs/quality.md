...
**Last reaudit:** 2026-08-17 (docs map #81, Core functional **31** `run`,
...
| **Q-41** | Keep. 9 → **31** `run` (Waves A–C). 236 skips remain; 55 `rpc-missing` + 35 `core-log` are the only growth that matches claimed surface. |
...
| **—** | Core functional `run` set | **31** unmodified v31.1 scripts (was 9). Remaining growth is **Q-41** |
