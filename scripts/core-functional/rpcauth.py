...
"""Core share/rpcauth/rpcauth.py — vendored so tool_rpcauth.py can import it.

Not a Core cmake product. Same generate_salt / generate_password /
password_to_hmac as Bitcoin Core v31.1.
"""
